...
import (
	...
	"go.klarlabs.de/nomi/internal/api"
	...
	browserplugin "go.klarlabs.de/nomi/internal/plugins/browser"
	...
	whatsappplugin "go.klarlabs.de/nomi/internal/plugins/whatsapp"
...
func main() {
	...
	// (klarlabs-studio/scout) as a subprocess per Connection and
